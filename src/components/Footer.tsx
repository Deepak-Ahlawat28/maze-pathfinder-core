      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="mb-12 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="p-6 rounded-xl bg-card/50 backdrop-blur-sm border border-accent/30 hover:border-accent transition-smooth hover:glow-cyan">
            ...
            <div className="p-6 rounded-xl bg-card/50 backdrop-blur-sm border border-lime/30 hover:border-lime transition-smooth hover:glow-lime">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8 pt-8 border-t border-border">
          <div>
